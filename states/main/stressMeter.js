...
var LightsOut = (function(lightsOut){
  ...
  lightsOut.StressMeter = function(game, player, enemies) {
    this.game = game;
    this.player = player;
  ...
  lightsOut.StressMeter.prototype = Object.create(Phaser.Sprite.prototype);
  lightsOut.StressMeter.prototype.constructor = lightsOut.StressMeter;

  lightsOut.StressMeter.prototype.update = function() {
    ...
    this.period = 2 + this.player.getHealth() / lightsOut.Player.MaxHealth;

    this.updateAlpha();
  };

  lightsOut.StressMeter.prototype.updateAlpha = function() {
